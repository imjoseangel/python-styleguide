...
[ADT](http://en.wikipedia.org/wiki/Abstract_data_type)-y.
...
4. **Deprecated:** application-specific imports that are part of the same
    ...
    You may find older Python Style code doing this, but it is no longer
...
# Style code may have these imports down here instead:
#from myproject.backend.hgwells import time_machine
#from myproject.backend.state_machine import main_loop
```
